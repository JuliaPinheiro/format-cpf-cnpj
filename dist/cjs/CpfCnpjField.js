...
var CpfCnpjField = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(core_1.TextField, { value: value, onChange: handleChange, label: 'CPF/CNPJ', placeholder: 'CPF/CNPJ', error: error, helperText: helperText, inputProps: { maxLength: 18 } }));
};
